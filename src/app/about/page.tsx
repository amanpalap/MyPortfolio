...
const SkillButton = ({ src, alt, label, className, classname }: any) => (
    <button className="relative hover:scale-110 transition-transform duration-200 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
        <span
            className={`inline-flex ${className} h-full w-full cursor-pointer items-center justify-center rounded-full px-3 py-1 text-sm text-white backdrop-blur-3xl font-mono font-bold`}
        >
            <Image src={src} width={100} height={100} alt={alt} className={`w-8 ${classname} h-8 m-2`} />
            {label}
        </span>
    </button>
);
...
export default function AboutPage() {
    return (
        <div className="px-4 sm:px-10 md:px-20 py-10 bg-black text-white">
            <section className="text-center sm:px-10 md:px-32 z-50">
                ...
                <div className="px-2 sm:px-6 md:px-10 font-mono text-base sm:text-lg md:text-xl">
                    ...
                    <div className="font-mono text-base sm:text-lg md:text-xl my-8">
            ...
            <section className="text-center bg-transparent mt-20">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold my-6 mb-10">
                ...
                <div className="my-10">
                    ...
                    <div className="flex flex-wrap gap-y-4 justify-center px-2 sm:px-10 md:px-40 space-x-2 sm:space-x-4">
